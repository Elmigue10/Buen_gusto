...
public class ProductoImpl implements IDatos {
    ...
    public void crear(Producto producto) throws Exception {
        ...
        String sql = "insert into producto (nombre,precio,descripcion, fkid_unidad,fkid_agrupacion) values(?,?,?,?,?);";
        try {
    ...
    public void actualizar(Producto producto) throws Exception {
        ...
        Connection conn = null;
        PreparedStatement st = null;
        String sql = "UPDATE producto set nombre=?,precio=?,descripcion=?,fkid_unidad=?,fkid_agrupacion=? WHERE id=" + producto.getId() + ";";
        try {
            conn = Conexion.getConnection();
            st = conn.prepareStatement(sql);
            st.setString(valores++, producto.getNombre());
    ...
    public List<Producto> listar() throws Exception {
        ...
        PreparedStatement st = null;
        ResultSet rs = null;
        String sql = "SELECT producto.id,producto.nombre,producto.precio,producto.descripcion,producto.fkid_unidad,unidad.unidad,producto.fkid_agrupacion, agrupacion.agrupacion \n" +
                "FROM producto \n" +
